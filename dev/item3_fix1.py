...
# The canonical DB initializer owns durable schema. The lifecycle store owns
# challenge rows, not table creation.
replace_one(
...
# Focused proof that canonical DB initialization alone owns the durable table.
