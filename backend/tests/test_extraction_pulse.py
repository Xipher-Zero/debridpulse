...
def test_extracting_status_badge_pulses_and_respects_reduced_motion():
    ...
    # this content lives in ui-transfer-contract.css (migrated from the
    # retired ui-legacy-foundation.css).
    css = (root / "frontend/static/ui-transfer-contract.css").read_text()
