...
(function () {
  ...
  const STYLES = Object.freeze([
    {href: '/ui-settings-downloads-completion.css?v=3', marker: 'data-dp-settings-downloads-completion-style'},
  ]);
  ...
  const RUNTIMES = Object.freeze([
    ...
    {src: '/ui-settings-downloads-completion.js?v=2', marker: 'data-dp-settings-downloads-completion'},
