...
(function () {
  ...
  const STYLES = Object.freeze([
    ...
    {href: '/ui-settings-maintenance-wipe.css?v=1', marker: 'data-dp-settings-maintenance-wipe-style'},
  ]);
  ...
  const RUNTIMES = Object.freeze([
    ...
    {src: '/ui-settings-maintenance-wipe.js?v=1', marker: 'data-dp-settings-maintenance-wipe'},
