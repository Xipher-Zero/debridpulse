...
| aria2 daemon ownership is injected (`Aria2Service(owns_daemon=...)`); no global settings lookup in the client | `test_settings_authority_contract.py`, `test_aria2_result_retention.py`, `test_v1111_aria2_security_boundary.py` |
