...
release_branch_block = "    branches:\n      - main\n      - '1.0.11'\n      - 'staging/**'"
replace_exact(".github/workflows/tests.yml", branch_block, release_branch_block, 2)
replace_exact(".github/workflows/container-security.yml", branch_block, release_branch_block, 2)
replace_exact(".github/workflows/fork-image.yml", branch_block, release_branch_block, 2)
replace_exact(
...
replace_exact(
    ".github/workflows/codeql.yml",
    "# CodeQL static analysis — runs on push/PR to main and staging PRs, plus weekly.",
    "# CodeQL static analysis — runs on main, the current release branch, staging PRs, and weekly.",
    1,
)
